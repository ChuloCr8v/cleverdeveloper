            ...
            <div className={styles.form_container}>
              ...
              <form data-aos="fade-up" action="https://formsubmit.co/chulocr8v@gmail.com" method="POST" target="_blank" rel="noopener noreferrer" >
                ...
                <div className={styles.form_group}>
                   ...
                   <input className="text-gray-800" type="text" nname="email" placeholder="Enter your email address here" required />
                </div>
                
                <div className={styles.form_group}>
                   <label htmlFor="location" className="font-bold text-gray-800">Location</label>
                   <input className="text-gray-800" type="text" name="location" placeholder="Enter your Location here" required />
                </div>
                
                <div className={styles.form_group}>
                   <label htmlFor="message" className="font-bold text-gray-800">Message</label>
                   <textarea className="text-gray-800" name="message" placeholder="Your message ☺" rows="7" cols="25" required />
                </div>
